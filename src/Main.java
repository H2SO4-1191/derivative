//There are some equations that the class won't solve accurately such as ln(ln(x)).
/*Important notes:
1- Enter equations using variable 'x'.
2- Enter exponentials and roots between [].. e.g: x^[2], (x+2)^[3] , x^[1/2].
3- Enter the multiplication and division between equations using & for mul and \ for div.. e.g: 2x^[3]\sn(x), ln(x)&e^[x]
 */
...
public class Main
{
    public static void main(String[] args)
    {
        ...
        System.out.print("Enter the equation: "); String equation = sin.next();
        System.out.print("Enter the value of x: "); double x = sin.nextDouble();
        System.out.print("Equation = " + equation + " ==> ");
        System.out.println("f(x) = " + result(equation, x));
        System.out.print("Derivative = " + derivative(equation) + " ==> ");
        System.out.print("df(x) = " + result(derivative(equation), x));
    }
